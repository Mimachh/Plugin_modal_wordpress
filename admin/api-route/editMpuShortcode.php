...
function editMpuShortcode($data) {
    ...
    if ($shortcode_id > 0) {
        ...
        if ($shortcode) {
            ...
            // if(isset($data['mpu_custom_logo']) && isset($data['mpu_custom_logo']) !== "") {
            //     $mpu_custom_logo = sanitize_text_field($data['mpu_custom_logo']);
            // } else if (isset($data['mpu_custom_logo']) && isset($data['mpu_custom_logo']) === "") {
            //     $mpu_custom_logo = get_post_meta($shortcode_id, 'mpu_custom_logo', true);
            // }
